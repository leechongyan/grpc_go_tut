...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x63, 0x6f, 0x75, 0x72, 0x73,
	0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x6d,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: course.grpc.CPU
	(*GPU)(nil),    // 1: course.grpc.GPU
	(*Memory)(nil), // 2: course.grpc.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: course.grpc.GPU.memory:type_name -> course.grpc.Memory
