...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=course.grpc.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x22, 0x9b, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12, 0x1b,
	...
	0x1e, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x63,
	...
	0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x75,
	0x72, 0x73, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: course.grpc.Screen.Panel
	(*Screen)(nil),            // 1: course.grpc.Screen
	(*Screen_Resolution)(nil), // 2: course.grpc.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: course.grpc.Screen.resolution:type_name -> course.grpc.Screen.Resolution
	0, // 1: course.grpc.Screen.panel:type_name -> course.grpc.Screen.Panel
