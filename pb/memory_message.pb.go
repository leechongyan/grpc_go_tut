...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=course.grpc.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x22, 0xa2, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14,
	...
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04, 0x75, 0x6e,
	0x69, 0x74, 0x22, 0x54, 0x0a, 0x04, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: course.grpc.Memory.Unit
	(*Memory)(nil),   // 1: course.grpc.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: course.grpc.Memory.unit:type_name -> course.grpc.Memory.Unit
